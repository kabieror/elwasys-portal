...
public class ChangePasswordWindow extends Window {
    ...
    private final PasswordField tfOldPw;
    private final User user;
    @SuppressWarnings("unchecked")
    public ChangePasswordWindow(User user) throws SQLException {
        this.user = user;
        ...
        this.tfOldPw = new PasswordField();
        content.addComponent(this.tfOldPw);
        this.tfOldPw.setCaption("Altes Passwort");
        this.tfOldPw.setWidth("100%");
        this.tfOldPw.setRequired(true);
        this.tfOldPw.setRequiredError("Bitte altes Passwort eingeben.");
        this.tfOldPw.addValidator(new OldPasswordValidator());
        this.tfOldPw.setValidationVisible(false);
        this.tfOldPw.focus();
    ...
    private void save() {
        // Felder validieren
        try {
            this.tfOldPw.validate();
            this.tfNewPw1.validate();
            this.tfNewPw2.validate();
        } catch (final InvalidValueException e) {
            this.tfOldPw.setValidationVisible(true);
    ...
    private class NewPasswordValidator implements Validator {
        ...
        public void validate(Object value) throws InvalidValueException {
            if (!ChangePasswordWindow.this.tfNewPw1.getValue().equals(ChangePasswordWindow.this.tfNewPw2.getValue())) {
    ...
    private class OldPasswordValidator implements Validator {
        ...
        @Override
        public void validate(Object value) throws InvalidValueException {
            if (!WashportalManager.instance.getSessionManager().getCurrentUser()
                    .checkPassword(ChangePasswordWindow.this.tfOldPw.getValue())) {
                throw new InvalidValueException("Das Passwort ist nicht korrekt.");
            }
        }
